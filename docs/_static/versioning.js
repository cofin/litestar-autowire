...
// Mirrors the SQLSpec docs setup. Dormant until the docs are hosted as multiple
// versions (i.e. once _static/versions.json lists more than the current build);
// loadVersions() returns null on a 404 and setupVersioning() then no-ops.
