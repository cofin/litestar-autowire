"""Custom Pygments styles for Litestar Autowire documentation."""
...
class LitestarAutowireLightStyle(Style):
    """Light syntax highlighting style for Litestar Autowire documentation."""

    name = "litestar-autowire-light"
...
class LitestarAutowireDarkStyle(Style):
    """Dark syntax highlighting style for Litestar Autowire documentation."""

    name = "litestar-autowire-dark"
